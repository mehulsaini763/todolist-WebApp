"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[613],{8050:function(e,t,n){n.d(t,{ET:function(){return sH},JU:function(){return sf},PL:function(){return sj},QT:function(){return sK},ad:function(){return sp},hJ:function(){return sd},oe:function(){return sW},pl:function(){return sG}});var r,s,i=n(5568),a=n(8341),o=n(4794),l=n(7365),u=n(8376);n(2040);let h="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tj{constructor(e,t,n,r,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,n){let r=new Map;return r.set(e,tG.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new tj(F.min(),r,new X(x),e7,ta())}}class tG{constructor(e,t,n,r,s){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new tG(n,t,ta(),ta(),ta())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let nj="WebChannelConnection";class nG extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http";this.mo=t+"://"+e.host,this.yo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get po(){return!1}Io(e,t,n,r,s){let i=n$(),a=this.To(e,t);g("RestConnection",`Sending RPC '${e}' ${i}:`,a,n);let o={};return this.Eo(o,r,s),this.Ao(e,a,o,n).then(t=>(g("RestConnection",`Received RPC '${e}' ${i}: `,t),t),t=>{throw y("RestConnection",`RPC '${e}' ${i} failed with error: `,t,"url: ",a,"request:",n),t})}vo(e,t,n,r,s,i){return this.Io(e,t,n,r,s)}Eo(e,t,n){e["X-Goog-Api-Client"]="gl-js/ fire/"+d,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,n)=>e[n]=t),n&&n.headers.forEach((t,n)=>e[n]=t)}To(e,t){let n=nK[e];return`${this.mo}/v1/${t}:${n}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Ao(e,t,n,r){let s=n$();return new Promise((i,a)=>{let o=new u.JJ;o.setWithCredentials(!0),o.listenOnce(u.tw.COMPLETE,()=>{try{switch(o.getLastErrorCode()){case u.jK.NO_ERROR:let t=o.getResponseJson();g(nj,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(t)),i(t);break;case u.jK.TIMEOUT:g(nj,`RPC '${e}' ${s} timed out`),a(new T(E.DEADLINE_EXCEEDED,"Request time out"));break;case u.jK.HTTP_ERROR:let n=o.getStatus();if(g(nj,`RPC '${e}' ${s} failed with status:`,n,"response text:",o.getResponseText()),n>0){let e=o.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(E).indexOf(t)>=0?t:E.UNKNOWN}(t.status);a(new T(e,t.message))}else a(new T(E.UNKNOWN,"Server responded with status "+o.getStatus()))}else a(new T(E.UNAVAILABLE,"Connection failed."));break;default:v()}}finally{g(nj,`RPC '${e}' ${s} completed.`)}});let l=JSON.stringify(r);g(nj,`RPC '${e}' ${s} sending request:`,r),o.send(t,"POST",l,n,15)})}Ro(e,t,n){let s=n$(),i=[this.mo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=(0,u.UE)(),o=(0,u.FJ)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;void 0!==h&&(l.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(l.xmlHttpFactory=new u.zI({})),this.Eo(l.initMessageHeaders,t,n),l.encodeInitMessageHeaders=!0;let c=i.join("");g(nj,`Creating RPC '${e}' stream ${s}: ${c}`,l);let d=a.createWebChannel(c,l),f=!1,m=!1,p=new nQ({ro:t=>{m?g(nj,`Not sending because RPC '${e}' stream ${s} is closed:`,t):(f||(g(nj,`Opening RPC '${e}' stream ${s} transport.`),d.open(),f=!0),g(nj,`RPC '${e}' stream ${s} sending:`,t),d.send(t))},oo:()=>d.close()}),w=(e,t,n)=>{e.listen(t,e=>{try{n(e)}catch(e){setTimeout(()=>{throw e},0)}})};return w(d,u.ii.EventType.OPEN,()=>{m||g(nj,`RPC '${e}' stream ${s} transport opened.`)}),w(d,u.ii.EventType.CLOSE,()=>{m||(m=!0,g(nj,`RPC '${e}' stream ${s} transport closed`),p.wo())}),w(d,u.ii.EventType.ERROR,t=>{m||(m=!0,y(nj,`RPC '${e}' stream ${s} transport errored:`,t),p.wo(new T(E.UNAVAILABLE,"The operation could not be completed")))}),w(d,u.ii.EventType.MESSAGE,t=>{var n;if(!m){let i=t.data[0];i||v();let a=i.error||(null===(n=i[0])||void 0===n?void 0:n.error);if(a){g(nj,`RPC '${e}' stream ${s} received error:`,a);let t=a.status,n=function(e){let t=r[e];if(void 0!==t)return tP(t)}(t),i=a.message;void 0===n&&(n=E.INTERNAL,i="Unknown error status: "+t+" with message "+a.message),m=!0,p.wo(new T(n,i)),d.close()}else g(nj,`RPC '${e}' stream ${s} received:`,i),p._o(i)}}),w(o,u.ju.STAT_EVENT,t=>{t.stat===u.kN.PROXY?g(nj,`RPC '${e}' stream ${s} detected buffering proxy`):t.stat===u.kN.NOPROXY&&g(nj,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{p.fo()},0),p}}function nW(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sK(e){e=sa(e,su);let t=sa(e.firestore,sg);return(function(e,t,n={}){let r=new C;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,s){var i;let a=new r4({next:i=>{t.enqueueAndForget(()=>r_(e,o));let a=i.docs.has(n);!a&&i.fromCache?s.reject(new T(E.UNAVAILABLE,"Failed to get document because the client is offline.")):a&&i.fromCache&&r&&"server"===r.source?s.reject(new T(E.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(i)},error:e=>s.reject(e)}),o=new rD((i=n.path,new eJ(i)),a,{includeMetadataChanges:!0,Ku:!0});return rA(e,o)})(await r7(e),e.asyncQueue,t,n,r)),r.promise})(sy(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),s=new sQ(e);return new sB(e,s,t._key,r,new sq(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sQ extends sP{constructor(e){super(),this.firestore=e}convertBytes(e){return new sv(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new su(this.firestore,null,t)}}function sj(e){e=sa(e,sh);let t=sa(e.firestore,sg),n=sy(t),r=new sQ(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
